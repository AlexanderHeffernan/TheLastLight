...
import flareButtonIconUrl from './ui/flare_button_64.png';
import openButtonIconUrl from './ui/open_button_64.png';
import pauseButtonIconUrl from './ui/pause_button_32.png';
...
export function loadAssets(scene: Phaser.Scene): void {
  ...
  scene.load.image('mobile-flare-icon', flareButtonIconUrl);
  scene.load.image('mobile-open-icon', openButtonIconUrl);
  scene.load.image('mobile-pause-icon', pauseButtonIconUrl);
